...
fprintf(output_5, "I(R1) & $%f$\\\\",  Ir1);
fprintf(output_5, "I(R2) & $%f$\\\\",  Ir2);
fprintf(output_5, "I(R3) & $%f$\\\\",  Ir3);
fprintf(output_5, "I(R4) & $%f$\\\\",  Ir4);
fprintf(output_5, "I(R5) & $%f$\\\\",  Ir5);
fprintf(output_5, "I(R6) & $%f$\\\\",  Ir6);
fprintf(output_5, "I(R7) & $%f$\\\\",  Ir7);
fprintf(output_5, "I(Vs) & $%f$\\\\",  Ivs);
fprintf(output_5, "I(Vd) & $%f$\\\\",  Ivd);
fprintf(output_5, "Id  & $%f$\\\\",  Id);
fprintf(output_5, "Ib & $%f$\\\\",  Ib);
fprintf(output_5, "Ic & $%f$\\\\",  Ic);
